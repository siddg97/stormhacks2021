...
Once you are ready, press “Let’s Practice” at the bottom, you will be redirected to join a room with our interview bot. Ensure your mic is working before starting.
...
export const SELECT_QUESTIONS_INFO = `Only the category of questions you select will be asked to you during the mock interview. A random question will be pulled from the customized pool
`;
