...
def test_add_questions_set_cookie(app):
    """
...
def test_add_questions_use_cookie(app):
    """
...
def test_get_questions_401(app):
    res = app.get(f"/api/questions")
    assert res.status_code == 401


def test_get_questions_404(app):
    uid = str(ObjectId())
    set_test_cookie(app, uid)
...
def test_get_questions_200(app):
    uid = str(ObjectId())
    set_test_cookie(app, uid)
